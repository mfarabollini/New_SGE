...
public class  GestionEnvioServicios {
    ...
    public static Cliente buscarClientePorCodigo(Integer codigo,boolean habilitado) throws ConectividadException{
        ...
        aCliente = clienteDAO.buscarPorCodigo(codigo,habilitado);
        return aCliente;
    }
    ...
    public static boolean guardarCliente(Cliente aCliente) throws ConectividadException{        
        Cliente aClienteLoc= null;
        boolean resultado = false;
        IClienteDAO clienteDAO = new ClienteDAO();
        String cuit = aCliente.getCuit();
        
        aClienteLoc = clienteDAO.buscarPorCuit(cuit);
        
        if(aClienteLoc==null){
            aClienteLoc =clienteDAO.buscarPorCodigo(aCliente.getNroCliente(), true);
        }
    ...
    public static boolean guardarLocalidad(Localidad aLocalidad) throws ConectividadException{        
        boolean resultado = false;
        ILocalidadDAO localidadDAO = new LocalidadDAO();
      
        /*Localidad localidadDAO = localidadDAO.buscarPorCuit(aMedio.getCuit());
        if(aMedioLoc==null){*/
        localidadDAO.persist(aLocalidad);
        resultado = true;
        //}
        return resultado;
    }
